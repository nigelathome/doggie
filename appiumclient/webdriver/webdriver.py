...
class WebDriver(webdriver.Remote):
    ...
    @property
    def get_ios_quick_source(self):
        """
        Gets the source of the current page.
        :Usage:
            driver.get_ios_quick_source
        """
        return self.execute(Command.GET_PAGE_SOURCE_IOS_QUICK)['value']
    ...
    def _addCommands(self):
        self.command_executor._commands[Command.GET_PAGE_SOURCE_IOS_QUICK] = \
            ('GET', '/session/$sessionId/quick_source')
