...
+ (id<FBResponsePayload>)handleGetQuickPageSourceCommand:(FBRouteRequest *)request
{
  ...
  /**
  BOOL handleAlert =
  ([(XCUIElement*)[allElements lastObject] bd_handleAlertView:request
                                                       handleType:BDAlertHandleFirst error:nil]||
  [(XCUIElement*)[allElements firstObject] bd_handleAlertView:request
                                                  handleType:BDAlertHandleFirst error:nil]);
...
//      }
  ...
  if ([allElements count] < 4)
    result = allElements.firstObject.debugDescription;
  else {
    NSMutableArray<NSString *> *childrenDescriptions = [NSMutableArray array];
    if([allElements.firstObject.debugDescription isEqualToString:@""])
      [childrenDescriptions addObject:[(XCUIElement*)allElements.firstObject debugDescription]];
    if([allElements.lastObject.debugDescription isEqualToString:@""])
      [childrenDescriptions addObject:[(XCUIElement*)allElements.lastObject debugDescription]];
