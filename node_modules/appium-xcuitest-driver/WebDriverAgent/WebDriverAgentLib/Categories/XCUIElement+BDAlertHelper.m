                     ...
                     error:(NSError **)error
{
  ...
  NSArray<XCUIElement *> *buttons = [alert.alertElement descendantsMatchingType:XCUIElementTypeButton].allElementsBoundByIndex;
...
- (BOOL)bd_handleTipsView:(FBApplication *)application {
  ...
  NSArray *labels = @[@"同意并继续", @"authorize close", @"mms voice close normal", @"取消"];
